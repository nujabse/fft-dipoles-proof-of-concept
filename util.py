...
def setup_pbc_multiple_basis(vectors, basis_atom, basis_atoms, cell_dimension, direct=False):
...
def plot_moment(lattice, dimension, basis_atom, color='bo', text=None):
    """
    Plot the supercell lattice and magnetic moment configuration
    Parameters
    ----------
    lattice: list
    dimension: int
    basis_atom: 1D numpy array
    color
    text
