...
# enumerate through all of basis vector, then get the padded matrix D_pad
        ...
        for c in range(it_c):
            for b in range(it_b):
                for a in range(it_a):
                    ...
                    # Here we still calculate the basic tensor through the dipole Matrix used in brute force
